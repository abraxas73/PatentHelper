...
### 🚀 재생성 PDF 다운로드 권한 문제 해결 (2025.01.20)
- **presigned URL 도입**: 한글 파일명 PDF 다운로드 시 403 에러 완전 해결
- **S3 직접 액세스**: CloudFront 대신 S3 presigned URL 사용 (1시간 유효)
- **UI 재구성**: 재생성된 PDF를 최상단, 추출된 원본 도면을 최하단으로 재배치
- **사용성 개선**: 중요도순 UI 요소 재정렬로 워크플로우 최적화
