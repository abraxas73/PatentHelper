...
- **PDF 재생성**: 편집된 이미지로 원본 구조 유지하며 PDF 재생성 (2025.01.16 개선)
...
- ✅ **PDF 재생성 개선**: 원본 페이지 구조 유지하며 편집된 도면만 치환
- ✅ **상태 표시 개선**: "재생성중"/"재생성완료" 태그로 진행 상태 시각화

### 기술적 개선
- 📊 DynamoDB originalPdfS3Key 필드 추가
- 🔧 create_annotated_pdf 메서드로 PDF 병합 정확도 향상
- 🎨 bbox 정보 활용한 도면 위치 정확도 개선
